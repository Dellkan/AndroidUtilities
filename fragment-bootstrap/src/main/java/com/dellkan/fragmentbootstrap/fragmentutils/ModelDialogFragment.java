 ...
 */
public abstract class ModelDialogFragment extends OverlayDialogFragment {
	...
	public static ModelDialogFragment newInstance(Class<? extends ModelDialogFragment> fragmentType, PresentationModelWrapper model) {
		try {
			ModelDialogFragment fragment = fragmentType.newInstance();
